...
const waterFreshwaterChronicAlkalinityCABC = (params) => {
  const { DCa } = params
...
const waterFreshwaterAcuteAmmoniaAsNApprovedCABC = (params) => {
  ...
  if (0 <= temperature && temperature <= 20 && 6.5 <= pH && pH < 8)  {
    return math.evaluate(`((100*((((0.52)/(pow(10, 0.03(20-${temperature})))) / (((1+pow(10, 7.4-${pH})))/(1.25)))/(2*0.822)))/(((1)/(100*(pow(10, ((0.09018+2729.92)/(273.2+ ${temperature}))-${pH})+1)))))`)
  } else if (0 <= temperature && temperature <= 20 && 8 <= pH && pH <= 9)  {
    return math.evaluate(`((100*((((0.52)/(pow(10, 0.03(20-${temperature})))))/(2*0.822)))/(((1)/(100*(pow(10, ((0.09018+2729.92)/(273.2+ ${temperature}))-${pH})+1))))) `)
...
const waterFreshwaterChronicAmmoniaAsNApprovedCABC = (params) => {
  const { pH, temperature } = params
  if ( !math.isValid(pH) || !math.isValid(temperature) ) { return null }
  if (temperature <= 20 && pH < 6.5) {
    return 1.21
  } else if (0 <= temperature && temperature < 15 && 6.5 <= pH && pH < 7.7) {
    return math.evaluate(`((((((((0.8)/(pow(10, 0.03(20-${temperature})))))/((((1+pow(10, 7.4-${pH})))/(1.25)))))/((((24*pow(10, 7.7-${pH})))/((1+pow(10, 7.4-${pH}))))*0.822*100)))/(((1)/(100*(pow(10, ((0.09018+2729.92)/(273.2+ ${temperature}))-${pH})+1)))))`)
  } else if (0 <= temperature && temperature < 15 && 7.7 <= pH && pH < 8) {
    return math.evaluate(`((((((((0.8)/(pow(10, 0.03*(20-${temperature})))))/((((1+pow(10, 7.4-${pH})))/(1.25)))))/(16*0.822*100)))/(((1)/(100*(pow(10, ((0.09018+2729.92)/(273.2+ ${temperature}))-${pH})+1)))))`)
  } else if (0 <= temperature && temperature < 15 && 8 <= pH && pH <= 9) {
    return math.evaluate(`((((((0.8)/(pow(10, 0.03*(20-${temperature})))))/(16*0.822*100)))/(((1)/(100*(pow(10, ((0.09018+2729.92)/(273.2+ ${temperature}))-${pH})+1)))))`)
  } else if (15 <= temperature && temperature < 20 && 6.5 <= pH && pH < 7.7) {
    return math.evaluate(`((((((((0.8)/(1.14)))/((((1+pow(10, 7.4-${pH})))/(1.25)))))/((((24*pow(10, 7.7-${pH})))/((1+pow(10, 7.4-${pH}))))*0.822*100)))/(((1)/(100*(pow(10, ((0.09018+2729.92)/(273.2+ ${temperature}))-${pH})+1)))))`)
  } else if (15 <= temperature && temperature < 20 && 7.7 <= pH && pH < 8) {
    return math.evaluate(`((((((((0.8)/(1.14)))/((((1+pow(10, 7.4-${pH})))/(1.25)))))/(16*0.822*100)))/(((1)/(100*(pow(10, ((0.09018+2729.92)/(273.2+ ${temperature}))-${pH})+1)))))`)
  } else if (15 <= temperature && temperature <20 && 8 <= pH && pH <= 9) {
    return math.evaluate(`((((((0.8)/(1.14)))/(16*0.822*100)))/(((1)/(100*(pow(10, ((0.09018+2729.92)/(273.2+ ${temperature}))-${pH})+1)))))`)
  } else if (temperature <= 20 && 9 < pH && pH <= 14) {
    return 0.102
  } else if (20 < temperature) {
    return null
...
module.exports = {
  ...
  waterFreshwaterChronicAlkalinityCABC,
